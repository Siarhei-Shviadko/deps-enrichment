...
from deps_enrichment.constants import PROJECT_NAME
from deps_enrichment.domain.model import IDocumentTypeRepository, ISupplementRepository
from deps_enrichment.extras import Database, DBDialect, DBDriver
from deps_enrichment.infrastructure.repositories import (
    DocumentTypeRepository,
    SupplementRepository,
)
from deps_enrichment.messaging.dispatcher import make_message_dispatcher
...
class Repositories(containers.DeclarativeContainer):
    ...
    supplement: providers.Singleton[ISupplementRepository] = providers.Singleton(
        SupplementRepository,
        database=datasources.postgres_datasource,
    )
...
class Containers(containers.DeclarativeContainer):
    ...
    supplement_service: providers.Singleton[SupplementService] = providers.Singleton(
        SupplementService,
